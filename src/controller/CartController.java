    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        add.setOnAction((event) -> {
            ...
            if (evt.getNb_participant() >= q) {
                for (int i = 0; i < q; i++) {
                    Tickett t = new Tickett(1, Session.user, evt.getId_event(), sqDate, 1, "****", 444444);
                    td.insert(t);
     ...
     try {
        ...
        /*  Allticket=td.DisplayAll();
       myTable.setItems(Allticket);
      
       name.setCellValueFactory(new PropertyValueFactory<>("time_boocked"));*/
