...
public class AddEventController implements Initializable {
        ...
        AddButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Date enddate = Date.valueOf(end);
                    ...
                    event ev = new event(1, cId, Session.user, Name.getText(), Description.getText(),nbp ,ConvertFileImage(image1), st, startdate, enddate, 0,price, 0, Address.getText());
    ...
    private void addimage(MouseEvent event) {
      ...
      public static String ConvertFileImage(Image image) throws SQLException, IOException {
        ...
        String ext = "jpg";
        File dir = new File("C:/xampp/htdocs/PIDEV/dorsaf/TechEvent/web/img");
