...
public class MyeventController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       userlist=uc.DisplayAllUserCategory(Session.current_user.getId_user());
       ...
       for(int i=0;i<userlist.size();i++){
        ...
        listCategory.setOnMouseClicked(event->{
         ...
         list =uc.DisplayAllUserCategory(Session.current_user.getId_user());
          ...
          uc.insert(new user_categorie(1, idDel, Session.current_user.getId_user()));
